...
const dayCards = [
  ...
  },
  {
    ...
    href: "/recipes",
    image: "/images/editorial/zoey-day-evening.png",
    position: "center 30%",
  },
  {
    time: "Wind Down",
    ...
    <main className="mz-page">
      <section className="mz-hero">
        ...
        <div className="mz-hero-copy">
          ...
          <p className="mz-hero-intro">
            Wellness, nutrition, recipes and inspiration—let’s
        ...
        <div className="mz-help-grid">
          {helpCards.map((card) => (
            <Link
              href={card.href}
              key={card.title}
              className="mz-help-card"
            >
              <div className="mz-help-icon">
                {card.icon}
              </div>
      ...
      <section className="mz-about">
        <div className="mz-about-photo">
          <picture>
            <source
              ...
              srcSet="/images/editorial/meet-zoey-mobile.png"
            />

            <img
              src="/images/editorial/meet-zoey-mobile.png"
        ...
        <div className="mz-about-copy">
          ...
          <p>
            I believe feeling better shouldn’t mean completely
            changing your life. Sometimes it’s a healthier meal,
            a morning walk, a few quiet minutes, or simply knowing
            where to begin.
          </p>

          <p>
            That’s what I’m here for—to help make the next step
            feel a little clearer, a little easier, and a lot more
            enjoyable.
          </p>
      ...
      <section className="mz-day">
        <div className="mz-section-heading">
          ...
          <h2>
            Small moments can change the feel of your whole day.
          </h2>

          <p>
            Explore a simple rhythm of movement, nourishment,
      ...
      <section className="mz-ask">
        ...
        <Link
          className="mz-button mz-ask-button"
          href="/ask-zoey"
        >
          Ask Zoey →
        </Link>
